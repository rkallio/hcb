...
#+header: :mkdirp yes :tangle hcbf/sample.env
#+begin_src sh
HCBF_HOST=127.0.0.1
HCBF_PORT=5434
...
#+header: :mkdirp yes :tangle hcbf/requirements.txt
#+begin_src python
Flask
psycopg2-binary
requests
...
#+header: :mkdirp yes :tangle hcbf/main.py
#+begin_src python
...
#+header: :mkdirp yes :tangle hcbf/templates/base.html.j2
#+begin_src jinja2
<!doctype html>
<html lang="en">
  <head>
...
#+header: :mkdirp yes :tangle hcbf/templates/home.html.j2
#+begin_src jinja2
...
#+header: :mkdirp yes :tangle hcbf/templates/journeys.html.j2
#+begin_src jinja2
{% extends "base.html.j2" %}
...
#+header: :mkdirp yes :tangle hcbf/templates/stations.html.j2
#+begin_src jinja2
{% extends "base.html.j2" %}
...
#+header: :mkdirp yes :tangle hcbf/templates/station.html.j2
#+begin_src jinja2
{% extends "base.html.j2" %}
...
#+header: :mkdirp yes :tangle hcbf/static/osm.js
#+begin_src js
...
#+header: :mkdirp yes :tangle hcbf/static/style.css
#+begin_src css
...
#+header: :mkdirp yes :tangle hcbf/journey.py
#+header: :noweb yes
#+begin_src python
<<JourneyParser>>
#+end_src

#+header: :mkdirp yes :tangle hcbf/station.py
#+header: :noweb yes
#+begin_src python
<<StationTypes>>
#+end_src
...
#+header: :mkdirp yes :tangle hcbb/requirements.txt
#+begin_src sh
Flask
flask_restful
psycopg2-binary
...
#+header: :mkdirp yes :tangle hcbb/db.py
#+begin_src python
import psycopg2
...
#+header: :mkdirp yes :tangle hcbb/main.py
#+begin_src python
...
#+header: :tangle hcbdb/main.py :mkdirp yes
#+begin_src python
...
#+header: :tangle hcbi/journeys/sample.env :mkdirp yes
#+begin_src sh
...
#+header: :tangle hcbi/journeys/main.py :mkdirp yes
#+begin_src python
import requests
import os
