...
#+header: :tangle sources/hcbf/sample.env
#+begin_src sh
HCBF_HOST=127.0.0.1
HCBF_PORT=5434
...
#+header: :tangle sources/hcbf/requirements.txt
#+begin_src python
Flask
psycopg2-binary
requests
...
#+header: :tangle sources/hcbf/main.py
#+begin_src python
...
#+header: :tangle sources/hcbf/templates/base.html.j2
#+begin_src jinja2
<!doctype html>
<html lang="en">
  <head>
...
#+header: :tangle sources/hcbf/templates/home.html.j2
#+begin_src jinja2
...
#+header: :tangle sources/hcbf/templates/journeys.html.j2
#+begin_src jinja2
{% extends "base.html.j2" %}
...
#+header: :tangle sources/hcbf/templates/stations.html.j2
#+begin_src jinja2
{% extends "base.html.j2" %}
...
#+header: :tangle sources/hcbf/templates/station.html.j2
#+begin_src jinja2
{% extends "base.html.j2" %}
...
#+header: :tangle sources/hcbf/static/osm.js
#+begin_src js
...
#+header: :tangle sources/hcbf/static/style.css
#+begin_src css
...
#+header: :tangle sources/hcbf/journey.py
#+header: :noweb yes
#+begin_src python
<<JourneyParser>>
#+end_src

#+header: :tangle sources/hcbf/station.py
#+header: :noweb yes
#+begin_src python
<<StationTypes>>
#+end_src
