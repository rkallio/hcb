...
- [[#minutes--journal][Minutes & Journal]]
  - [[#improvde-documentation][Improvde documentation]]
...
- [[#implementation][Implementation]]
  ...
  - [[#the-database][The database]]
    - [[#database-preparation-script][Database preparation script]]
...
All application sources are provided at X.  Download and untar them locally:
...
Here’s a Docker command to get the database running.  If you have not yet done so, first [[#define-a-network][define a Docker network]].
...
#+header: :mkdirp yes :tangle sources/hcbf/sample.env
#+begin_src sh
HCBF_HOST=127.0.0.1
HCBF_PORT=5434
...
#+header: :mkdirp yes :tangle sources/hcbf/requirements.txt
#+begin_src python
Flask
psycopg2-binary
requests
...
#+header: :mkdirp yes :tangle sources/hcbf/main.py
#+begin_src python
...
#+header: :mkdirp yes :tangle sources/hcbf/templates/base.html.j2
#+begin_src jinja2
<!doctype html>
<html lang="en">
  <head>
...
#+header: :mkdirp yes :tangle sources/hcbf/templates/home.html.j2
#+begin_src jinja2
...
#+header: :mkdirp yes :tangle sources/hcbf/templates/journeys.html.j2
#+begin_src jinja2
{% extends "base.html.j2" %}
...
#+header: :mkdirp yes :tangle sources/hcbf/templates/stations.html.j2
#+begin_src jinja2
{% extends "base.html.j2" %}
...
#+header: :mkdirp yes :tangle sources/hcbf/templates/station.html.j2
#+begin_src jinja2
{% extends "base.html.j2" %}
...
#+header: :mkdirp yes :tangle sources/hcbf/static/osm.js
#+begin_src js
...
#+header: :mkdirp yes :tangle sources/hcbf/static/style.css
#+begin_src css
...
#+header: :mkdirp yes :tangle sources/hcbf/journey.py
#+header: :noweb yes
#+begin_src python
<<JourneyParser>>
#+end_src

#+header: :mkdirp yes :tangle sources/hcbf/station.py
#+header: :noweb yes
#+begin_src python
<<StationTypes>>
#+end_src
...
#+header: :mkdirp yes :tangle sources/hcbb/sample.env
#+begin_src sh
PSQL_DB=hcb
PSQL_USER=postgres
PSQL_PASS=postgres
...
#+header: :mkdirp yes :tangle sources/hcbb/requirements.txt
#+begin_src sh
Flask
flask_restful
psycopg2-binary
...
#+header: :mkdirp yes :tangle sources/hcbb/db.py
#+begin_src python
import psycopg2
...
#+header: :mkdirp yes :tangle sources/hcbb/main.py
#+begin_src python
...
“The database” is a PostgreSQL database.  Here are the SQL statements that prepare it.  See the section [[#running-locally-with-docker][Running locally with Docker]] for setup instructions.
...
#+header: :tangle sources/hcbdb/requirements.txt :mkdirp yes
#+begin_src python
psycopg2-binary
#+end_src
...
#+header: :tangle sources/hcbdb/main.py :mkdirp yes
#+begin_src python
...
#+header: :tangle sources/hcbi/stations/requirements.txt :mkdirp yes
#+begin_src text
requests
psycopg2-binary
#+end_src
...
#+header: :tangle sources/hcbi/stations/sample.env :mkdirp yes
#+begin_src sh
...
#+header: :tangle sources/hcbi/stations/main.py :mkdirp yes
#+begin_src python
import os
import requests
from collections import namedtuple
...
#+header: :tangle sources/hcbi/journeys/requirements.txt :mkdirp yes
#+begin_src text
requests
psycopg2-binary
#+end_src
...
#+header: :tangle sources/hcbi/journeys/sample.env :mkdirp yes
#+begin_src sh
...
#+header: :tangle sources/hcbi/journeys/main.py :mkdirp yes
#+begin_src python
import requests
import os
