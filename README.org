      ...
      <table>
        <thead>
          <tr>
            <th>Name</th>
            <th>Address</th>
            <th># of journeys starting here</th>
            <th># of journeys ending here</th>
        </thead>
        <tbody>
          <tr>
            <td>{{ station.english_name }}</td>
            <td>{{ station.finnish_address }} </td>
            <td>{{ journeys_from_here }}</td>
            <td>{{ journeys_to_here }}</td>
          </tr>
        </tbody>
      </table>
      <div id="osm-map"></div>
...
element.style = 'height:100vh;width:300px';
