...
- [[#implementation][Implementation]]
  ...
  - [[#the-backend][The backend]]
    - [[#robot-tests-for-backend][Robot tests for backend]]
...
Testing was heavily encouraged in the project assignment.  I decided to implement only the tip of the testing pyramid due to a few reasons:

1. Useful unit tests necessitate modularized code
2. Restructuring the source code into modules takes time and adds boilerplate and more complexity
3. I am very familiar with unit testing so I wanted to learn about other topics instead
4. The code won't be maintained by me or anyone else, so spending time on unit tests provides little benefit

There are a few unit tests for the backend, see [[#unit-tests-for-backend][Unit tests for backend]]].

Instructions for running the E2E tests are documented in [[#tests-for-frontend][Tests for frontend]] and [[#robot-tests-for-backend][Robot tests for backend]].
