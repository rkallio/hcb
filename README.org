...
Here are the build and env files for reference:
...
#+header: :tangle hcb-setup-database/create-db.sql
#+begin_src sql
CREATE DATABASE hcb;
#+end_src

#+name: create-journey-stmt
#+header: :tangle hcb-setup-database/create-tables.sql
#+begin_src sql
BEGIN;
