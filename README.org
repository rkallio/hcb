...
#+header: :tangle sources/hcbb/requirements.txt
#+begin_src sh
Flask
flask_restful
psycopg2-binary
...
#+header: :tangle sources/hcbb/db.py
#+begin_src python
import psycopg2
...
#+header: :tangle sources/hcbb/main.py
#+begin_src python
...
#+header: :tangle sources/hcbi/journeys/sample.env
#+begin_src sh
...
#+header: :tangle sources/hcbi/journeys/main.py
#+begin_src python
import requests
import os
